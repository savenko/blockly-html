...
HtmlGenerator["add_class"] = function (block) {
  var dropdown_name = block.getFieldValue("NAME");
  var value_trigger_class = HtmlGenerator.valueToCode(
    block,
    "trigger_class",
    HtmlGenerator.ORDER_ATOMIC
  );
  var value_action_class = HtmlGenerator.valueToCode(
    block,
    "action_class",
    HtmlGenerator.ORDER_ATOMIC
  );
...
HtmlGenerator["mouse_event"] = function (block) {
  var dropdown_on = block.getFieldValue("on");
  var value_into = HtmlGenerator.valueToCode(
    block,
    "into",
    HtmlGenerator.ORDER_ATOMIC
  );
...
HtmlGenerator["class_name"] = function (block) {
...
HtmlGenerator["this"] = function (block) {
  // TODO: Assemble JavaScript into code variable.
  var code = "this";
  // TODO: Change ORDER_NONE to the correct strength.
  return [code, HtmlGenerator.ORDER_NONE];
