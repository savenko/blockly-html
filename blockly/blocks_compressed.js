...
Blockly.Blocks.procedures_callnoreturn = {
  ...
  setProcedureParameters_: function (a, b) {
    var c,
      d = Blockly.Procedures.getDefinition(
          ...
          if ((c = this.getInput("ARG" + f)))
            (c = c.connection.targetConnection),
              ...
              e &&
                ...
                (c.disconnect(), c.getSourceBlock().bumpNeighbours_());
          ...
          for (f = 0; f < this.arguments_.length; f++)
            (e = this.quarkIds_[f]),
              e in this.quarkConnections_ &&
                ...
                Blockly.Mutator.reconnect(c, this, "ARG" + f) ||
...
Blockly.Constants.Text.TEXT_APPEND_TOOLTIP_EXTENSION = function () {
  var a = this;
  this.setTooltip(function () {
    return Blockly.Msg.TEXT_APPEND_TOOLTIP
      ? Blockly.Msg.TEXT_APPEND_TOOLTIP.replace("%1", a.getFieldValue("VAR"))
      : "";
  });
};
